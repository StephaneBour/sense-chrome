(function () {
    ...
    function populateSavedElem(saved_elem) {
        const s = saved_elem.method + " " + saved_elem.endpoint + "\n" + (saved_elem.data || "");
    ...
    function applySavedElem(saved_elem) {
        ...
        let s = prefix + saved_elem.method + " " + saved_elem.endpoint;
    ...
    function init() {
        ...
        saved_popup.find("#saved_delete").click(function (k) {
    ...
    function showSaved(saved_popup) {
        ...
        $.each(getSaved(), function (i, saved_elem) {
            ...
            let disc = '<span class="label ' + classByMethod(saved_elem.method) + '">' + saved_elem.method + '</span>  ' + saved_elem.title + '<br><small>' + saved_elem.endpoint;
            const date = moment(saved_elem.time);
